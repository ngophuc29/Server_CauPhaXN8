...
export declare class OssClient {
     ...
     */
    upload(bucketKey: string, filename: string, filepath: string, accessToken: string, cancellationToken?: AbortController, projectScope?: string, requestIdPrefix?: string, optionalArgs?: {
        onProgress?: (percentCompleted: number) => void;
    }): Promise<ObjectDetails>;
    download(bucketKey: string, objectKey: string, filePath: string, accessToken: string, cancellationToken?: AbortController, projectScope?: string, requestIdPrefix?: string, optionalArgs?: {
        onProgress?: (percentCompleted: number) => void;
    }): Promise<void>;
    /**
     ...
     */
    batchCompleteUpload(accessToken: string, bucketKey: string, optionalArgs?: {
    ...
    /**
         ...
         * @throws {RequiredError}
         */
    batchSignedS3Download(accessToken: string, bucketKey: string, requests: Batchsigneds3downloadObject, optionalArgs?: {
     ...
     * @memberof OSSApi
     */
    batchSignedS3Upload(accessToken: string, bucketKey: string, optionalArgs?: {
    ...
    /**
         ...
         * @throws {RequiredError}
         */
    completeSignedS3Upload(accessToken: string, bucketKey: string, objectKey: string, contentType: string, body: Completes3uploadBody, optionalArgs?: {
    ...
    /**
         ...
         * @throws {RequiredError}
         */
    copyTo(accessToken: string, bucketKey: string, objectKey: string, newObjName: string, optionalArgs?: {
        xAdsAcmNamespace?: string;
        xAdsAcmCheckGroups?: string;
        xAdsAcmGroups?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ObjectDetails>;
    /**
     ...
     * @memberof OSSApiInterface
     */
    createBucket(accessToken: string, xAdsRegion: CreateBucketXAdsRegionEnum, bucketPayload: CreateBucketsPayload, optionalArgs?: {
        options?: ApsServiceRequestConfig;
    }): Promise<Bucket>;
    /**
         ...
         * @throws {RequiredError}
         */
    createSignedResource(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        access?: CreateSignedResourceAccessEnum;
        useCdn?: boolean;
   ...
   * @memberof OSSApiInterface
   */
    deleteBucket(accessToken: string, bucketKey: string, optionalArgs?: {
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
  ...
  * @memberof OSSApiInterface
  */
    deleteObject(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        AdsAcmNamespace?: string;
        xAdsAcmCheckGroups?: string;
        xAdsAcmGroups?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
         ...
         * @throws {RequiredError}
         */
    deleteSignedResource(accessToken: string, hash: string, optionalArgs?: {
        region?: DeleteSignedResourceRegionEnum;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
     ...
     * @memberof OSSApiInterface
     */
    getBucketDetails(accessToken: string, bucketKey: string, optionalArgs?: {
        options?: ApsServiceRequestConfig;
    }): Promise<Bucket>;
    /**
        ...
        * @memberof OSSApiInterface
        */
    getBuckets(accessToken: string, optionalArgs?: {
        region?: GetBucketsRegionEnum;
        limit?: number;
        startAt?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Buckets>;
    /**
        ...
        * @memberof OSSApiInterface
        */
    getObjectDetails(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        ifModifiedSince?: string;
        xAdsAcmNamespace?: string;
        xAdsAcmCheckGroups?: string;
        xAdsAcmGroups?: string;
        _with?: GetObjectDetailsWithEnum;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof OSSApiInterface
     */
    getObjects(accessToken: string, bucketKey: string, optionalArgs?: {
        limit?: number;
        beginsWith?: string;
        startAt?: string;
    ...
    /**
        ...
        * @throws {RequiredError}
        */
    getSignedResource(accessToken: string, hash: string, optionalArgs?: {
        range?: string;
        ifNoneMatch?: string;
        ifModifiedSince?: string;
        acceptEncoding?: string;
        region?: GetSignedResourceRegionEnum;
     ...
     * @throws {RequiredError}
     */
    headObjectDetails(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        ifModifiedSince?: string;
        xAdsAcmNamespace?: string;
        xAdsAcmCheckGroups?: string;
        xAdsAcmGroups?: string;
        _with?: HeadObjectDetailsWithEnum;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
     ...
     * @throws {RequiredError}
     */
    postUpload(accessToken: string, bucketKey: string, contentLength: number, xAdsObjectName: string, xAdsObjectSize: number, optionalArgs?: {
        contentType?: string;
        xAdsAcmNamespace?: string;
        xAdsAcmCheckGroups?: string;
        xAdsAcmGroups?: string;
     ...
     * @throws {RequiredError}
     */
    signedS3Download(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        ifNoneMatch?: string;
        ifModifiedSince?: string;
     ...
     * @throws {RequiredError}
     */
    signedS3Upload(accessToken: string, bucketKey: string, objectKey: string, optionalArgs?: {
        xAdsAcmScopes?: string;
        parts?: number;
        firstPart?: number;
        uploadKey?: string;
     ...
     * @throws {RequiredError}
     */
    uploadSignedResource(accessToken: string, hash: string, contentLength: number, body: File, optionalArgs?: {
        contentType?: string;
        contentDisposition?: string;
        xAdsRegion?: UploadSignedResourceXAdsRegionEnum;
        ifMatch?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ObjectDetails>;
    /**
     ...
     * @throws {RequiredError}
     */
    uploadSignedResourcesChunk(accessToken: string, hash: string, contentRange: string, sessionId: string, body: File, optionalArgs?: {
        contentType?: string;
        contentDisposition?: string;
        xAdsRegion?: UploadSignedResourcesChunkXAdsRegionEnum;
        options?: ApsServiceRequestConfig;
    }): Promise<ObjectDetails>;
}
