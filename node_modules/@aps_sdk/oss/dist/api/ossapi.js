        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.response) {
                    ...
                    throw new base_1.OssApiError(`signedS3Download Request failed with status : ${error.response.status} and error message: ${error.response.data.developerMessage}`, error);
                }
                else if (error.request) {
