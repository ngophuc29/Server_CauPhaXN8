...
import { ObjectStatusEnum } from "../model";
...
export class OSSFileTransfer {
    ...
    getS3SignedDownloadUrlWithRetry(bucketKey, objectKey, accessToken, requestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                ...
                try {
                    var objectStatusEnumString = ObjectStatusEnum.Complete;
                    var response = yield this.ossApi.signedS3Download(accessToken, bucketKey, objectKey, requestId);
    ...
    writeToFileStreamFromUrl(fileStream, Url, start, end, requestId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarHeaderParameter = {};
