...
import { AllProperties, DerivativeHead, ObjectTree, Region, SpecificProperties } from "../model";
export class ModelDerivativeClient {
    ...
    specifyReferences(accessToken, urn, specifyReferencesRequest, optionalArgs) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.jobsApi.specifyReferences(accessToken, urn, (_a = optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.region) !== null && _a !== void 0 ? _a : Region.Us, specifyReferencesRequest, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
            return response.content;
        });
    }
    ...
    getManifest(accessToken, urn, optionalArgs) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.manifestApi.getManifest(accessToken, urn, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.acceptEncoding, (_a = optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.region) !== null && _a !== void 0 ? _a : Region.Us, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
            return response.content;
        });
    }
    deleteManifest(accessToken, urn, optionalArgs) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.manifestApi.deleteManifest(accessToken, urn, (_a = optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.region) !== null && _a !== void 0 ? _a : Region.Us, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
            return response.content;
        });
    }
    ...
    headCheckDerivative(accessToken, urn, derivativeUrn, optionalArgs) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.derivativesApi.headCheckDerivative(accessToken, urn, derivativeUrn, (_a = optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.region) !== null && _a !== void 0 ? _a : Region.Us, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
