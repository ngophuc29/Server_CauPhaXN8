...
export class MetadataApi extends BaseApi {
    ...
    fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options);
