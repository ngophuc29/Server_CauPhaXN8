...
const DerivativesApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        getDerivativeUrl: (accessToken, derivativeUrn, urn, minutesExpiration, responseContentDisposition, region, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
class DerivativesApi extends base_1.BaseApi {
    ...
    getDerivativeUrl(accessToken, derivativeUrn, urn, minutesExpiration, responseContentDisposition, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.DerivativesApiFp)(this.sdkManager).getDerivativeUrl(accessToken, derivativeUrn, urn, minutesExpiration, responseContentDisposition, region, options);
