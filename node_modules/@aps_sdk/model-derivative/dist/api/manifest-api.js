...
const ManifestApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getManifest: (accessToken, urn, acceptEncoding, region, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
...
class ManifestApi extends base_1.BaseApi {
    ...
    getManifest(accessToken, urn, acceptEncoding, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.ManifestApiFp)(this.sdkManager).getManifest(accessToken, urn, acceptEncoding, region, options);
                const response = yield request(this.axios);
