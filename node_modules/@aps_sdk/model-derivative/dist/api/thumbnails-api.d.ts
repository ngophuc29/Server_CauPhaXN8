...
import { Height, Region, Width } from '../model';
/**
...
export declare const ThumbnailsApiAxiosParamCreator: (apsConfiguration?: IApsConfiguration) => {
     ...
     */
    getThumbnail: (accessToken: string, urn: string, width?: Width, height?: Height, region?: Region, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ThumbnailsApiFp: (sdkManager?: SdkManager) => {
     ...
     * @throws {RequiredError}
     */
    getThumbnail(accessToken: string, urn: string, width?: Width, height?: Height, region?: Region, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>>;
};
/**
...
export interface ThumbnailsApiInterface {
     ...
     */
    getThumbnail(accessToken: string, urn: string, width?: Width, height?: Height, region?: Region, options?: ApsServiceRequestConfig): Promise<ApiResponse>;
}
/**
