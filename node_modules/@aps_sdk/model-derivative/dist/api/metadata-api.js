...
const MetadataApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        fetchSpecificProperties: (accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getAllProperties: (accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, region, objectid, forceget, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getModelViews: (accessToken, urn, acceptEncoding, region, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getObjectTree: (accessToken, urn, modelGuid, acceptEncoding, region, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
...
const MetadataApiFp = function (sdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options);
...
class MetadataApi extends base_1.BaseApi {
    ...
    fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.MetadataApiFp)(this.sdkManager).fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, specificPropertiesPayload, options);
