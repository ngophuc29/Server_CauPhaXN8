...
const UsersApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        getUserInfo: (authorization_1, ...args_1) => __awaiter(this, [authorization_1, ...args_1], void 0, function* (/* accessToken: string, */ authorization, options = {}) {
...
class UsersApi extends base_1.BaseApi {
    ...
    getUserInfo(/* accessToken: string, */ authorization, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.UsersApiFp)(this.sdkManager).getUserInfo(/* accessToken, */ authorization, options);
                ...
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`getUserInfo Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
