...
exports.TokenApi = exports.TokenApiFp = exports.TokenApiAxiosParamCreator = void 0;
...
const TokenApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        authorize: (/*accessToken: string*/ clientId, responseType, redirectUri, nonce, state, scope, responseMode, prompt, authoptions, codeChallenge, codeChallengeMethod) => {
            // verify required parameter 'clientId' is not null or undefined
            (0, common_1.assertParamExists)('authorize', 'clientId', clientId);
            // verify required parameter 'responseType' is not null or undefined
            (0, common_1.assertParamExists)('authorize', 'responseType', responseType);
            // verify required parameter 'redirectUri' is not null or undefined
            (0, common_1.assertParamExists)('authorize', 'redirectUri', redirectUri);
         ...
         * @throws {RequiredError}
         */
        fetchToken: (authorization_1, grantType_1, code_1, redirectUri_1, codeVerifier_1, refreshToken_1, scope_1, clientId_1, ...args_1) => __awaiter(this, [authorization_1, grantType_1, code_1, redirectUri_1, codeVerifier_1, refreshToken_1, scope_1, clientId_1, ...args_1], void 0, function* (/* accessToken: string, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options = {}) {
         ...
         * @throws {RequiredError}
         */
        getKeys: (...args_2) => __awaiter(this, [...args_2], void 0, function* (/* accessToken: string */ options = {}) {
         ...
         * @throws {RequiredError}
         */
        getOidcSpec: (...args_3) => __awaiter(this, [...args_3], void 0, function* (/* accessToken: string,  */ options = {}) {
         ...
         * @throws {RequiredError}
         */
        introspectToken: (authorization_2, token_1, clientId_2, ...args_4) => __awaiter(this, [authorization_2, token_1, clientId_2, ...args_4], void 0, function* (/* accessToken: string, */ authorization, token, clientId, options = {}) {
         ...
         * @throws {RequiredError}
         */
        logout: (/* accessToken: string, */ postLogoutRedirectUri) => {
         ...
         * @throws {RequiredError}
         */
        revoke: (authorization_3, token_2, tokenTypeHint_1, clientId_3, ...args_5) => __awaiter(this, [authorization_3, token_2, tokenTypeHint_1, clientId_3, ...args_5], void 0, function* (/*accessToken: string,*/ authorization, token, tokenTypeHint, clientId, options = {}) {
...
const TokenApiFp = function (sdkManager) {
    const localVarAxiosParamCreator = (0, exports.TokenApiAxiosParamCreator)(sdkManager.apsConfiguration);
    return {
        /**
         * Displays a sign-in page where users of your application can authorize the application to access resources on their behalf.  Invoking this operation is the first step in authenticating users and retrieving an authorization code grant. The authorization code that is generated remains valid for 5 minutes, while the ID token stays valid for 60 minutes. Any access tokens you obtain are valid for 60 minutes, and refresh tokens remain valid for 15 days.  This operation has a rate limit of 500 calls per minute.  **Note:** This operation is intended for use with client-side applications only. It is not suitable for server-side applications.
         * @summary Authorize User
         ...
         * @throws {RequiredError}
         */
        authorize(/* accessToken: string, */ clientId, responseType, redirectUri, state, nonce, scope, responseMode, prompt, authoptions, codeChallenge, codeChallengeMethod) {
         ...
         * @throws {RequiredError}
         */
        fetchToken(/* accessToken: string, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.fetchToken(/* accessToken, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options);
         ...
         * @throws {RequiredError}
         */
        getKeys(/* accessToken: string,  */ options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getKeys(/* accessToken, */ options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getOidcSpec(/* accessToken: string, */ options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getOidcSpec(/* accessToken, */ options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        introspectToken(/* accessToken: string,  */ authorization, token, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.introspectToken(/* accessToken, */ authorization, token, clientId, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        revoke(/* accessToken: string, */ token, authorization, tokenTypeHint, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.revoke(/* accessToken, */ token, authorization, tokenTypeHint, clientId, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
    };
...
class TokenApi extends base_1.BaseApi {
    ...
    authorize(/* accessToken: string, */ clientId, responseType, redirectUri, state, nonce, scope, responseMode, prompt, authoptions, codeChallenge, codeChallengeMethod) {
        ...
        try {
            const url = (0, exports.TokenApiFp)(this.sdkManager).authorize(/* accessToken, */ clientId, responseType, redirectUri, state, nonce, scope, responseMode, prompt, authoptions, codeChallenge, codeChallengeMethod);
            ...
            throw new base_1.AuthenticationApiError(`authorize  failed with error : ${error}`);
        }
    }
    /**
     * Returns an access token or refresh token.  * If `grant_type` is `authorization_code`, returns a 3-legged access token for authorization code grant.  * If `grant_type` is `client_credentials`, returns a 2-legged access token for client credentials grant. * If `grant_type` is `refresh_token`, returns new access token using the refresh token provided in the request.  Traditional Web Apps and Server-to-Server Apps should use the ``Authorization`` header with Basic Authentication for this operation. Desktop, Mobile, and Single-Page Apps should use ``client_id`` in the form body instead.  This operation has a rate limit of 500 calls per minute.
    ...
    fetchToken(/* accessToken: string, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.TokenApiFp)(this.sdkManager).fetchToken(/* accessToken, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options);
                ...
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`fetchToken Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`fetchToken Request failed with no response received: ${error.request}`);
                    throw new base_1.AuthenticationApiError(`fetchToken Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    getKeys(/* accessToken: string, */ options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.TokenApiFp)(this.sdkManager).getKeys(/* accessToken, */ options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`getKeys Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`getKeys Request failed with no response received: ${error.request}`);
                    throw new base_1.AuthenticationApiError(`getKeys Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    getOidcSpec(/* accessToken: string, */ options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.TokenApiFp)(this.sdkManager).getOidcSpec(/* accessToken, */ options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`getOidcSpec Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`getOidcSpec Request failed with no response received: ${error.request}`);
                    throw new base_1.AuthenticationApiError(`getOidcSpec Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    introspectToken(/* accessToken: string, */ authorization, token, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.TokenApiFp)(this.sdkManager).introspectToken(/* accessToken, */ authorization, token, clientId, options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`introspectToken Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`introspectToken Request failed with no response received: ${error.request}`);
                    throw new base_1.AuthenticationApiError(`introspectToken Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    logout(/* accessToken: string,  */ postLogoutRedirectUri) {
        ...
        try {
            const url = (0, exports.TokenApiFp)(this.sdkManager).logout(/* accessToken, */ postLogoutRedirectUri);
            this.logger.logInfo("logout Request completed successfully");
            return url;
        }
        catch (error) {
            this.logger.logError(`logout Request failed with error ${error}`);
            throw new base_1.AuthenticationApiError(`logout Request failed with error ${error}`);
        }
    }
    /**
     * Revokes an active access token or refresh token.  An application can only revoke its own tokens.  This operation has a rate limit of 100 calls per minute.
    ...
    revoke(/* accessToken: string, */ token, authorization, tokenTypeHint, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.TokenApiFp)(this.sdkManager).revoke(/* accessToken, */ token, authorization, tokenTypeHint, clientId, options);
                const response = yield request(this.axios);
                this.logger.logInfo(`revoke Request completed successfully with status code: ${response.status}`);
                return new autodesk_sdkmanager_1.ApiResponse(response, response);
            }
            catch (error) {
                if (error.response) {
                    ...
                    throw new base_1.AuthenticationApiError(`revoke Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`revoke Request failed with no response received: ${error.request}`);
                    throw new base_1.AuthenticationApiError(`revoke Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
