...
export class TokenApi extends BaseApi {
    ...
    fetchToken(/* accessToken: string, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield TokenApiFp(this.sdkManager).fetchToken(/* accessToken, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options);
    ...
    getKeys(/* accessToken: string, */ options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield TokenApiFp(this.sdkManager).getKeys(/* accessToken, */ options);
                const response = yield request(this.axios);
    ...
    getOidcSpec(/* accessToken: string, */ options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield TokenApiFp(this.sdkManager).getOidcSpec(/* accessToken, */ options);
                const response = yield request(this.axios);
    ...
    introspectToken(/* accessToken: string, */ authorization, token, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield TokenApiFp(this.sdkManager).introspectToken(/* accessToken, */ authorization, token, clientId, options);
                const response = yield request(this.axios);
    ...
    revoke(/* accessToken: string, */ token, authorization, tokenTypeHint, clientId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield TokenApiFp(this.sdkManager).revoke(/* accessToken, */ token, authorization, tokenTypeHint, clientId, options);
                const response = yield request(this.axios);
